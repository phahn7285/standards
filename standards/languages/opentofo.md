...
\- OpenTofu MUST be used as an open-source Terraform-compatible IaC tool where selected.
...
\- OpenTofu usage MUST align with agents/devsecops.md and agents/security.md.
...
&nbsp; - Author and maintain OpenTofu configurations
...
&nbsp; - creating or modifying OpenTofu configurations
...
\- OpenTofu projects SHOULD follow standard layout:
